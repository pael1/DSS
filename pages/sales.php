      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="sales.php"><i class="fa fa-money"></i><span>Sales</span></a></li>
        </section>
      </aside>
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-money"></i> Sales</h1>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
        ...
        <table class = "table" class = "table-bordered" border="1" id="div_print">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>₱ <?php echo number_format($f_query['payable'])?></td>
              <td><?php echo date('M.d.Y', strtotime(str_replace('-', '/', $f_query['det'])))?></td>
